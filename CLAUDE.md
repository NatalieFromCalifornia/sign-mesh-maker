...
- **Slots are finite and a slicer collapses whatever it cannot fit, choosing for itself.** The export clamps assignments to the user's slot count and the editor warns above it, so merging or deleting down is a deliberate act rather than a surprise at the printer.
